...
The same application is loaded by default in [JDL-Studio](https://start.jhipster.tech/jdl-studio/) and [JHipster IDE](https://jhipster.ddocs.cnjhipster-ide/) as well.
...
You can then use JDL files to generate entities:
  ...
  - declare your applications, deployments, entities and relationships or create and download the file with [JDL-Studio](https://start.jhipster.tech/jdl-studio/) or [JHipster IDE](https://jhipster.ddocs.cnjhipster-ide/),
...
[
Filtering](https://jhipster.ddocs.cnentities-filtering/) options can be activated on a per entity basis: filter `<entity name>` or for all entities: filter `*`.
